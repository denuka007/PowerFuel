...
<html>
  <head>
    ...
    <!-- Nucleo Icons -->
    <link href="customer/css/nucleo-icons.css" rel="stylesheet" />
    <link href="customer/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Popper -->
    <script src="https://unpkg.com/@popperjs/core@2"></script>
    <!-- Main Styling -->
    <link href="customer/css/soft-ui-dashboard-tailwind.css?v=1.0.4" rel="stylesheet" />
  ...
  <body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <!-- sidenav  -->
    @include('layouts.customer.cussidebar')
    <!-- end sidenav -->

    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
      <!-- Navbar -->
      @include('layouts.customer.cusnav')
      <!-- end Navbar -->
